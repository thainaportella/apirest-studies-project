...
public class DozerConverterPersonTest {
    ...
    br.com.tpprojects.personrequestapirest.unittests.mapper.mocks.MockPerson inputObject;

    @BeforeEach
    public void setUp() {
        inputObject = new br.com.tpprojects.personrequestapirest.unittests.mapper.mocks.MockPerson();
    }
